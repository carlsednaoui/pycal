...
# Store client_id and client_secret in local module
import alt_client_secrets
...
client_id = alt_client_secrets.CLIENT_ID
client_secret = alt_client_secrets.CLIENT_SECRET
